...
int main(void) {
    ...
    /* Pick the FB config/visual with the most samples per pixel */
    {
        ...
        for (int i = 0; i < num_fb_configs; ++i) {
            ...
            if (vi) {
                ...
                glXGetFBConfigAttrib(display, fb_configs[i], GLX_SAMPLE_BUFFERS,
                                     &samp_buf);
                glXGetFBConfigAttrib(display, fb_configs[i], GLX_SAMPLES,
                                     &samples);
    ...
    xcb_create_colormap(pConn, XCB_COLORMAP_ALLOC_NONE, colormap, window,
                        vi->visualid);
    ...
    if (!isExtensionSupported(glxExts, "GLX_ARB_create_context") ||
        ...
        context = glXCreateContextAttribsARB(display, fb_config, 0, True,
                                             context_attribs);
