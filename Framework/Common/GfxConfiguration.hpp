...
#ifndef NEXUS_GFXCONFIGURATION_HPP
#define NEXUS_GFXCONFIGURATION_HPP
...
struct GfxConfiguration {
    ...
    friend std::ostream& operator<<(std::ostream& out,
        ...
        out << "GfxConfiguration:" << " R:" << conf.redBits
            << " G:" << conf.greenBits << " B:" << conf.blueBits
            << " A:" << conf.alphaBits << " D:" << conf.depthBits
            << " S:" << conf.stencilBits << " M:" << conf.msaaSamples
            << " W:" << conf.screenWidth << " H:" << conf.screenHeight
            << std::endl;
        return out;
    }
};
...
#endif  // NEXUS_GFXCONFIGURATION_HPP
